...
void MainMenu::load() {
	...
	engine->ettMngr->addEntity((int)EntityTypes::VOXEL);
	Model3D* c = (Model3D*)engine->ettMngr->getComponent((int)EntityTypes::VOXEL, 0, (int)ComponentTypes::MODEL3D);
	c->filename = "untitled.dae";
	ON_ENTITY_CREATED::call((int)EntityTypes::VOXEL, 0);
